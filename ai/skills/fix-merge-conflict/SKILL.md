...
description: Fix all merge conflicts on the current Git branch non-interactively and make the repo buildable and tested. Use when you encounter merge conflicts that need resolution.
